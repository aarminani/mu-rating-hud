  ...
  ],
  {
    variants: {
      variant: {
        ...
        danger: "text-[color:var(--red)] hover:text-white",
      },
      size: {
...
const bgVariants: Record<string, string> = {
  ...
  secondary:
    "[--btn-bg:var(--inset)] group-hover:[--btn-bg:var(--hover)] group-active:[--btn-bg:var(--field)] bg-[var(--btn-bg)] shadow-[0_0_0_1px_var(--btn-bg)] group-active:shadow-[0_0_0_0px_var(--btn-bg)]",
  brand:
    "[--btn-bg:var(--accent)] group-hover:[--btn-bg:var(--accent-ink)] group-active:[--btn-bg:var(--accent-dim)] bg-[var(--btn-bg)] shadow-[0_0_0_1px_var(--btn-bg),0_0_14px_var(--accent-glow)] group-active:shadow-[0_0_0_0px_var(--btn-bg)]",
  danger:
    "[--btn-bg:transparent] bg-[var(--red-tint)] shadow-[0_0_0_1px_color-mix(in_oklab,var(--red)_40%,transparent)] group-hover:bg-[#7f1d1d] group-active:shadow-[0_0_0_0px_var(--red)]",
  tertiary:
...
const activeBgVariants: Record<string, string> = {
  ...
  brand:
    "[--btn-bg:var(--accent-ink)] bg-[var(--btn-bg)] shadow-[0_0_0_1px_var(--btn-bg),0_0_14px_var(--accent-glow)]",
  danger: "bg-[#7f1d1d] shadow-[0_0_0_1px_var(--red)]",
};
